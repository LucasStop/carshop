  ...
  return (
    <main className="min-h-screen py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-3xl font-bold text-black mb-8">Política de Privacidade</h1>
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p className="mb-6">
            ...
            publica um anúncio ou entra em contato conosco. Isso inclui:
          </p>
          <ul className="list-disc pl-6 mb-6">
            <li>Nome, email e telefone</li>
            <li>Informações sobre veículos que você anuncia</li>
          ...
          <p className="mb-6">
            Não vendemos suas informações pessoais. Podemos compartilhar informações apenas nas 
            seguintes situações:
          </p>
          <ul className="list-disc pl-6 mb-6">
          ...
          <p className="mb-6">
            ...
            cumprir obrigações legais, geralmente por um período de 5 anos após o encerramento 
            da conta.
          </p>
          ...
          <p className="mb-6">
            ...
            significativas por email ou através de aviso em nosso site.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6">
            <li>Email: privacidade@luxurycars.com</li>
